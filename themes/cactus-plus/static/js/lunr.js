...
!function () {
    ...
    t.version = "1.0.0", t.utils = {}, t.utils.warn = function (t) {
        return function (e) {
        ...
        }) : e.toString().trim().toLowerCase().split(t.tokenizer.separator) : []
    }, t.tokenizer.separator = /[\s\-]+/, t.tokenizer.load = function (t) {
        ...
        var n = this.pipeline.run(this.tokenizerFn(e)), i = new t.Vector, r = [],
        ...
        n.forEach(function (e, n, s) {
            var a = 1 / s.length * this._fields.length * o, h = this,
        ...
        var t = {
            ...
            i = "[aeiouy]", r = n + "[^aeiouy]*", o = i + "[aeiou]*", s = "^(" + r + ")?" + o + r,
            a = "^(" + r + ")?" + o + r + "(" + o + ")?$", h = "^(" + r + ")?" + o + r + o + r, u = "^(" + r + ")?" + i,
            l = new RegExp(s), c = new RegExp(h), f = new RegExp(a), d = new RegExp(u), p = /^(.+?)(ss|i)es$/,
            v = /^(.+?)([^s])s$/, g = /^(.+?)eed$/, m = /^(.+?)(ed|ing)$/, y = /.$/, S = /(at|bl|iz)$/,
            w = new RegExp("([^aeiouylsz])\\1$"), k = new RegExp("^" + r + i + "[^aeiouwxy]$"), x = /^(.+?[^aeiou])y$/,
            ...
            _ = /^(.+?)(s|t)(ion)$/, z = /^(.+?)e$/, O = /ll$/, P = new RegExp("^" + r + i + "[^aeiouwxy]$"),
            T = function (n) {
                var i, r, o, s, a, h, u;
